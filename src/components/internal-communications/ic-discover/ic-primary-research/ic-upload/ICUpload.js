...
function ICUpload() {
  ...
  const handleIcUploadFileChange = (event) => {
  ...
  const handleIcUploadFile = () => {
    fileInputRef.current.click();
  };

  return (
    <div className="ic-upload-main-container">
      <div className="ic-upload-container">
        <div className="ic-upload-header">
          <p className="ic-upload-header-para-heading">Add Transcripts</p>
          <p className="ic-upload-header-para">
            Upload interview transcripts, think tank session takeaways, and
            survey results.
          </p>
        </div>
        <div className="ic-upload-documents">
          <input
            type="file"
            ref={fileInputRef}
            onChange={handleIcUploadFileChange}
            style={{ display: "none" }}
            multiple
          />
          <div
            className="ic-upload-file-display-area"
            onClick={handleIcUploadFile}
          >
            <div className="ic-upload-file-svg">
              <svg
                fill="#000000"
                height="20"
                width="20"
            ...
            <div className="ic-upload-files">
              {fileNames.map((name, index) => (
                <div key={index} className="ic-upload-file-name">
                  {name}
                </div>
              ))}
            </div>
          </div>
          <div className="ic-upload-button">
